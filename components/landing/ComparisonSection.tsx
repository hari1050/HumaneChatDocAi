    ...
    <section className="bg-black py-20 px-6 md:px-10 lg:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-400 text-center text-lg mb-16">
          See how WriticaAI transforms your writing experience from fragmented to flowing.
        </p>

        <div className="grid md:grid-cols-2 gap-8">
          {/* Before Column */}
          <div className="bg-[#111] rounded-xl p-8 shadow-[0_0_20px_rgba(0,0,0,0.5)] hover:shadow-[0_0_25px_rgba(255,0,0,0.05)] transition-all duration-300">
            <div className="text-red-500 text-xl mb-6">Before WriticaAI</div>
            <div className="space-y-6">
              <div>
                <h3 className="text-white font-semibold mb-2">Multiple Applications</h3>
                <p className="text-gray-400 text-sm">
                  Constantly switching between your document, browser tabs, and AI tools.
                </p>
              </div>
              <div>
                <h3 className="text-white font-semibold mb-2">Lost Context</h3>
                <p className="text-gray-400 text-sm">
                  Copying and pasting between tools, losing your train of thought.
                </p>
              </div>
              <div>
                <h3 className="text-white font-semibold mb-2">Frustration & Delays</h3>
                <p className="text-gray-400 text-sm">
                  Projects take longer, quality suffers, and creativity is stifled.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* After Column */}
          <div className="bg-[#111] rounded-xl p-8 shadow-[0_0_20px_rgba(0,0,0,0.5)] hover:shadow-[0_0_25px_rgba(0,255,0,0.05)] transition-all duration-300">
            <div className="text-green-500 text-xl mb-6">After WriticaAI</div>
            <div className="space-y-6">
              <div>
