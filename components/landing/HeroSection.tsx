...
export default function HeroSection() {
  ...
  const originalText =
    "The future of writing is here. WriticaAI enables writers to produce high-quality content faster than ever before."
  const improvedText =
    "The revolution in writing has arrived! WriticaAI empowers writers to craft compelling, high-quality content with unprecedented speed and efficiency."
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-1/2">
            ...
            >
              ...
              <p className="text-zinc-500 text-base md:text-lg max-w-xl mt-6">
                ...
                <span className="text-white font-medium">WriticaAI brings everything into one seamless space.</span> When
