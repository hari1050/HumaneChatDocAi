...
const StatCard = ({
  ...
  <div className="bg-[#111] rounded-xl p-8 shadow-[0_0_20px_rgba(0,0,0,0.5)] hover:shadow-[0_0_25px_rgba(255,255,255,0.05)] transition-all duration-300">
    <div className="rounded-full p-3 bg-[#222] w-12 h-12 flex items-center justify-center mb-4">{icon}</div>
    ...
    <section className="bg-black py-20 px-6 md:px-10 lg:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-400 text-center text-lg mb-16">
          See how WriticaAI revolutionizes document workflows across your organization
        </p>
