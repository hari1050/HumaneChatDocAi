                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {subscription.cancel_at_period_end && (
                      <div>
                        <h3 className="text-sm font-medium text-muted-foreground">Cancellation Status</h3>
                        <p className="text-lg font-semibold text-destructive">Cancels at period end</p>
                      </div>
                    )}
                  </div>
                </div>
